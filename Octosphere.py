...
# These lines run your main function!
# You can change the questions if you wish.
# Only yes-or-no style questions will make sense.

print ("To play this game, enter 'mystical_octosphere(question)'")
print ("Only yes/no questions will make sense!")
print ("E.g. mystical_octosphere('Does he love me?')")
